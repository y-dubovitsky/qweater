...
public class SecurityServiceImpl implements SecurityService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SecurityServiceImpl.class); //TODO Заменить на

    @Autowired
    private AuthenticationManager authenticationManager; //? TODO Что это?
